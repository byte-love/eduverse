...
import com.eduverse.message.domain.enums.SmsTemplate;
import com.eduverse.common.exceptions.BadRequestException;
import com.eduverse.common.utils.CollUtils;
import com.eduverse.common.utils.RandomUtils;
import com.eduverse.common.utils.StringUtils;
import com.eduverse.message.api.client.AsyncSmsClient;
import com.eduverse.message.domain.dto.SmsInfoDTO;
import com.eduverse.user.service.ICodeService;
...
import static com.eduverse.api.constants.SmsConstants.VERIFY_CODE_PARAM_NAME;
import static com.eduverse.common.constants.ErrorInfo.Msg.INVALID_VERIFY_CODE;
import static com.eduverse.user.constants.UserConstants.USER_VERIFY_CODE_KEY;
import static com.eduverse.user.constants.UserConstants.USER_VERIFY_CODE_TTL;
