...
Eduverse（知界）是一个面向**在线教育场景**的全栈微服务平台，由传智教育研究院研发。平台覆盖从课程管理、学员报名、在线学习、互动答疑、考试测评到支付结算、营销推广、数据分析和 AI 智能辅导的完整业务闭环。
...
与 AI 智能体对话：课程推荐、咨询、购买引导、知识点讲解、历史会话、暂停输出*
<p align="center"><img src="docs/images/AI-Agent.gif" alt="智能体演示" width="1000" /></p>
