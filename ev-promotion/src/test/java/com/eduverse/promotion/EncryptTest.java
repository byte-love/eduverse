package com.eduverse.promotion;

import cn.hutool.core.util.ArrayUtil;
import cn.hutool.crypto.SecureUtil;
import cn.hutool.crypto.digest.HMac;
import com.eduverse.common.exceptions.BadRequestException;
import com.eduverse.promotion.utils.AESUtil;
import com.eduverse.promotion.utils.Base32;
import com.eduverse.promotion.utils.BitConverter;
...
public class EncryptTest {
    ...
    private AESUtil aesUtil = new AESUtil("eduverse-test-key-in", "eduverse-test-ivinit");
    @Test
    ...
    // @Test
    // void testCodeUtil() {
    //     CodeUtil codeUtil = new CodeUtil(new AESUtil("eduverse-test-key-in", "eduverse-test-ivinit"));
    //
